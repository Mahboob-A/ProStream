...
def sslcommerz_payment_gateway(request, amount):
    ...
    post_body['success_url'] = 'http://16.171.185.111/finance/success/'
    post_body['fail_url'] = 'http://16.171.185.111/finance/failed/'
    post_body['cancel_url'] = 'http://16.171.185.111/'
    # post_body['success_url'] = 'http://16.171.185.111/finance/success/'
    # post_body['fail_url'] = 'http://16.171.185.111/finance/failed/'
    # post_body['cancel_url'] = 'http://16.171.185.111/'
