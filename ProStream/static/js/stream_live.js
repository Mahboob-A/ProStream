...
let toggleVideoShare = async () => {
        ...
        hostUid = uid 
        console.log('hostUid: ', hostUid, " ----- ", 'uid: ', uid, "config.uid: ", config.uid)
...
document.getElementById('stream-button').addEventListener('click', toggleStream)

//document.getElementById('screen-share-button').addEventListener('click', toggleScreenShare)

document.getElementById('leave-button').addEventListener('click', handleUserLeave)
